...
function hintQuestions() {
    ...
    if (newWords === sWords[0]) {
        ...
        hint.innerHTML = 'HINT: What year was the first Iron Man movie released, kicking off the Marvel Cinematic Universe?';
        ...
        hint.innerHTML = 'HINT: What is the alien race Loki sends to invade Earth in The Avengers?';
        ...
        hint.innerHTML = 'HINT: Where does Peggy tell Steve she wants to meet him for a dance, before he plunges into the ice?';
        ...
        hint.innerHTML = "HINT: Who does the Mad Titan sacrifice to acquire the Soul Stone?";
        ...
        hint.innerHTML = 'HINT: What is the name of the little boy Tony befriends while stranded in the Iron Man 3?';
        ...
        hint.innerHTML = 'HINT: What is the name of the organisation revealed to have taken over S.H.I.E.L.D. in Captain America: The Winter Soldier?';
        ...
        hint.innerHTML = "HINT: Director Taika Waititi also played which comedic Thor: Ragnarok character?";
        ...
        hint.innerHTML = 'HINT:. Which planet does Peter Quill retrieve the Orb containing the Power Stone?';
